...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gray-800 rounded-lg text-white">
      ...
      <p className="mt-4 text-xs opacity-70 border p-2 border-dashed">Используйте стрелки для движения. Поедание яблок дает функоины и пытается открыть новый трек для плейлиста, если есть свободные слоты.</p>
    </div>
  );
}
